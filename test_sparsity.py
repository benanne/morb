...
from test_utils import generate_data, get_context, plot_data
...
evaluate = t.compile_function(initial_vmap, mb_size=100, monitors=[m, m_model], name='evaluate', update=False, mode=mode)
